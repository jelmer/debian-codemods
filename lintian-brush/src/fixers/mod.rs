...
mod debian_control_repeats_field_name_in_value;
mod debian_files_list_in_source;
...
mod debian_rules_uses_deb_build_opts;
...
mod homepage_for_cpan_package_contains_version;
